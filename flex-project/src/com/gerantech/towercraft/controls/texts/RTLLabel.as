package com.gerantech.towercraft.controls.texts
{
	...
	public class RTLLabel extends TextBlockTextRenderer
	{
		...
		{
			if(fontSize == 0)
				this.fontSize = AppModel.instance.theme.regularFontSize * AppModel.instance.scale;
			else if(fontSize<4)
				this.fontSize = fontSize * AppModel.instance.theme.regularFontSize * AppModel.instance.scale;
			else
