...
public function BattleHeader(label:String, itsMe:Boolean)
{
	super();
	this.itsMe = itsMe;
	this.label = label;
...
override protected function initialize():void
{
	...
	labelDisplay.layoutData = new AnchorLayoutData(NaN, NaN, NaN, NaN, 0, -padding * 2.4); 
	...
	scaleX = 0;
	Starling.juggler.tween(this, 0.6, {scaleX:1, transition:Transitions.EASE_OUT_BACK});
}
}
}