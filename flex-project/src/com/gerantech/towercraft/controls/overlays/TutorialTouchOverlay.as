package com.gerantech.towercraft.controls.overlays
{
	...
	public class TutorialTouchOverlay extends TutorialOverlay
	{
		...
		{
			Starling.juggler.tween( finger, 0.15, {delay : delay,		scale : 0.85*appModel.scale*2});
			Starling.juggler.tween( finger, 0.50, {delay : delay+0.4,	scale : 1.00*appModel.scale*2, onComplete:touchFinger, onCompleteArgs:[2], transition:Transitions.EASE_OUT_BACK});
		}			
	}
}