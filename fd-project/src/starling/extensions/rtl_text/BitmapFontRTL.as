...
package starling.extensions.rtl_text
{
    ...
    public class BitmapFontRTL extends BitmapFont
    {
        ...
        override public function arrangeChars(width:Number, height:Number, text:String, format:TextFormat, options:TextOptions):Vector.<BitmapCharLocation>
        {
		//	trace("arrangeChars", width, height, text)
