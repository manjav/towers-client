...
override protected function character_completeHandler(event:Event):void 
{
	...
	var position:Rectangle = new Rectangle(stage.stageWidth * (side == 0?0.20:0.8), height - charachter.height - 20, 1, 1);
...
override protected function tootlip_eventsHandler(event:Event):void
{
	...
	{
		appModel.navigator.addLog(loc("popup_offer_30_error"), 300);
		return;
	}
