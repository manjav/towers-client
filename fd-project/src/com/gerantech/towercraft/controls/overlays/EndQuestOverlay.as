...
override protected function initialize():void
{
	...
	var hasRetry:Boolean = playerIndex > -1 && appModel.battleFieldView.battleData.battleField.field.isOperation && player.getLastOperation() > 3 && !appModel.battleFieldView.battleData.isLeft;
